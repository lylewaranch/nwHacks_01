...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func createNewBubbleParentNode(_ text : String) -> SCNNode {
        ...
        //        let fullNameArr = latestPrediction.characters.split{$0 == " "}.map(String.init)
        //        Alamofire.request("https://apis.solarialabs.com/shine/v1/vehicle-stats/specs", method: .get, parameters: ["make": fullNameArr[0], "model" : fullNameArr[1], "year" : "2016", "full-data" : "true", "apikey" : "ZwA2OAkN5SSGDJgEu9GsgmomYzvxzWHN"])
        ...
        //                    mpgText = object["City_Conventional_Fuel"].int!
        //                }
        //        }
